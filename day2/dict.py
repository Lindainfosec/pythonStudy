...
#print(id_db[22043549306143632] )  输出对应这个身份证的信息
#id_db[22043549306143632]['name'] = "WangMinghu"   修改对应位置的值。
#id_db[22043549306143632]['qq_of_wife'] = 38232354  插入一个值
