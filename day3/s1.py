...
# li = (11,22,3,11,2)
li = "alexalex"
s1.update(li)  自动执行add将li中的内容添加到s1
print(s1)
"""
...
old_set = set(old_dict.keys()) #获取上面的数据


remove_set = old_set.difference(new_set)#删除输出new里面存在的，但是old里面不存在。
